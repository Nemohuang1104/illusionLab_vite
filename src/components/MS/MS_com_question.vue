  ...
  data() {
    return {
      emojis: [
        ...
        ["fa-brands fa-line", "Line", "@illusionLabLN"],
        ["fa-brands fa-instagram", "Instagram", "@illusionLabIG"],
        ["fa-brands fa-youtube", "YouTube", "@illusionLabYT"],
        ["fa-brands fa-threads", "Threads", "@illusionLabTS"],
        ["fa-brands fa-bilibili", "BiliBili", "@illusionLabBL"],
        ["fa-brands fa-tiktok", "TikTok", "@illusionLabTT"],
        ["fa-brands fa-x-twitter", "X", "@illusionLabXX"],
        ["fa-brands fa-weibo", "Weibo", "@illusionLabWB"],
      ],
      animationTiming: '27s',
      carouselItems: 9,
      slideChangeTiming: 3, 
