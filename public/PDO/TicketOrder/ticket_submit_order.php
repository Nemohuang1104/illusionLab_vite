...
if (
    ...
    !isset($data['time']) || !isset($data['guestNumber']) || !isset($data['totalAmount']) || 
...
$sql = "INSERT INTO ticket_order (NAME, COMPANY, TAX_ID, EVENT_ID, EVENT_NAME, DATE, TIME, QUANTITY, TOTAL_PRICE, ORDER_DATE, ORDER_STATUS, PAYMENT_DATE, PAYMENT_METHOD, NOTE) 
        VALUES (:name, :companyName, :taxID, :eventId, :eventName, :date, :time, :guestNumber, :totalAmount, NOW(), :orderStatus, NOW(), :paymentMethod, :comments)";
